...
const OrdersPage = () => {
	...
	return (
		<main className="h-full overflow-y-auto p-3 sm:p-5 lg:p-6 min-w-0">
			<div className="mb-5 sm:mb-6">
				<p style={{ ...INTER, fontSize: 11, color: "#aaa", fontWeight: 500 }}>Catalogue / Orders</p>
				<h1 style={{ ...SORA, fontSize: 20, fontWeight: 900, color: "#111", letterSpacing: "-0.3px" }}>Orders</h1>
			</div>

			<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5 sm:gap-4 mb-5 sm:mb-6">
			...
			<div className="w-full">
				{ordersLoading ? (
					<div className="w-full bg-white rounded-xl sm:rounded-2xl flex items-center justify-center" style={{ height: 300, border: "1px solid #f0f0f0" }}>
