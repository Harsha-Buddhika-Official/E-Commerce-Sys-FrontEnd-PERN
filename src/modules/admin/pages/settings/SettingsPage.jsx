...
export default function SettingsPage() {
  ...
  const { saving, saved, errors: apiErrors, updatePassword, clearErrors } = useUpdatePassword();
    ...
    <div className="h-full overflow-y-auto bg-[#f5f5f5] p-5 lg:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <h1 style={{ ...SORA, fontSize: 20, fontWeight: 900, color: "#111", letterSpacing: "-0.3px" }}>Settings</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-5">
                ...
                >
                  ...
                  {soon && (
                    <span
                      ...
                      style={{ ...INTER, fontSize: 9, fontWeight: 700, backgroundColor: "#f0f0f0", color: "#aaa" }}
                    >
                      Soon
                    </span>
                  )}
        ...
        <div className="xl:col-span-3 flex flex-col gap-5">
          ...
          {saved && (
            ...
            >
              <CheckCircleOutlinedIcon style={{ fontSize: 18, color: "#16a34a", flexShrink: 0 }} />
              <p style={{ ...INTER, fontSize: 13, fontWeight: 600, color: "#15803d" }}>
              ...
              <div className="flex justify-end pt-2">
                ...
                >
                  {saving ? (
                    ...
                    <><CheckCircleOutlinedIcon style={{ fontSize: 16 }} /> Updated!</>
                  ) : (
