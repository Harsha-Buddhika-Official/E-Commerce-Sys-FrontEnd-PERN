    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      ...
      >
        ...
        <p style={{ ...INTER, fontSize: 13, color: "#555", lineHeight: 1.7 }}>
          ...
          <strong style={{ color: "#111" }}>&quot;{product.name}&quot;</strong>?
...
function ActionBtn({ icon, label, variant = "ghost", onClick, disabled = false }) {
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 8,
        ...(disabled
          ? { backgroundColor: "#f0f0f0", border: "1px solid #e0e0e0", color: "#bbb", cursor: "not-allowed" }
          : s
        ),
      }}
  ...
  return (
    ...
    >
      ...
      <td style={{ padding: "12px 16px", overflow: "hidden", maxWidth: 0 }}>
        ...
        <p style={{ ...INTER, fontSize: 11, color: "#bbb", marginTop: 2 }}>
          {product.brand}
        </p>
      </td>
      <td style={{ padding: "12px 16px" }}>
      ...
      <td style={{ padding: "12px 16px" }}>
        <div className="flex items-center gap-1.5">
          <span
            ...
            style={{ backgroundColor: inStock ? "#16a34a" : "#e53935" }}
          />
          <span
            style={{ ...INTER, fontSize: 12, fontWeight: 700, color: "#111" }}
          >
            {product.stockCount}
          </span>
        </div>
      ...
      <td style={{ padding: "12px 16px" }}>
        <span
          style={{ ...INTER, fontSize: 13, fontWeight: 800, color: "#e53935" }}
        >
      ...
      <td style={{ padding: "12px 16px" }}>
        <div className="flex items-center gap-1.5">
          <ActionBtn
            icon={<VisibilityOutlinedIcon style={{ fontSize: 13 }} />}
            label="View"
            variant="ghost"
            onClick={() => onView(product)}
          />
          <ActionBtn
            icon={<EditOutlinedIcon style={{ fontSize: 13 }} />}
            label="Edit"
            variant="dark"
            onClick={() => onEdit(product)}
          />
          <ActionBtn
            icon={<DeleteOutlineOutlinedIcon style={{ fontSize: 13 }} />}
            label="Delete"
            variant="danger"
...
function CategoryChip({ label, active, onClick }) {
  return (
    <button
      onClick={onClick}
      className="flex items-center px-4 py-2 rounded-xl border shrink-0 cursor-pointer transition-all whitespace-nowrap"
      style={{
        ...INTER,
        fontSize: 12,
        fontWeight: 700,
...
const ProductsPage = () => {
  ...
  const canEdit = can(["admin", "super_admin"]);
  ...
  const handleView = useCallback(
    (p) => navigate(`/admin/products/${p.id}`),
    [navigate],
  );
  const handleEdit = useCallback(
    (p) => navigate(`/admin/products/${p.id}/edit`, { state: { product: p } }),
    [navigate],
  );
  ...
  return (
    <main className="h-full overflow-y-auto bg-[#f5f5f5] p-5 lg:p-6">
      ...
      {error && (
        ...
        >
          <WarningAmberOutlinedIcon
            style={{ fontSize: 16, color: "#e53935", flexShrink: 0 }}
          />
          <p
            style={{
              ...INTER,
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
		...
		style={{
			...
			fontWeight: 700,
			border: "none",
			backgroundColor: canCreate ? "#111" : "#e0e0e0",
			color:           canCreate ? "#fff" : "#aaa",
			cursor:          canCreate ? "pointer" : "not-allowed",
		}}
		onMouseEnter={(e) => { if (canCreate) e.currentTarget.style.backgroundColor = "#222"; }}
		onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = canCreate ? "#111" : "#e0e0e0"; }}
		>
          ...
          <div className="overflow-x-auto">
            ...
            >
              ...
              <thead>
                ...
                >
                  {["", "Product", "Category", "Stock", "Price", "Actions"].map(
                    (h) => (
                      <th
                        key={h}
                        className="text-left"
