...
export default function CartSuccessToast() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-atomic="true"
      className={`fixed bottom-5 right-5 z-[80] w-[calc(100vw-2rem)] max-w-sm rounded-2xl border border-zinc-200 bg-white shadow-[0_18px_48px_rgba(0,0,0,0.18)] transition-all duration-300 ease-out ${
        visible
