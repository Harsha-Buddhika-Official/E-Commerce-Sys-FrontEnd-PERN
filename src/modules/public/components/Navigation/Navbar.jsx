      ...
      <nav className="sticky top-0 z-50 w-full bg-[#0a0a0a] border-b border-zinc-800">
        <div className="max-w-480 mx-auto h-20 px-4 md:px-8 lg:px-80 flex items-center justify-between">
          ...
          <div className="hidden xl:flex items-center gap-8">
            ...
            <Link to="/services" className="text-white text-base font-medium hover:text-zinc-300 transition-colors">Services</Link>
            <Link to="/offers" className="text-white text-base font-medium hover:text-zinc-300 transition-colors">Offers and Deals</Link>
            <Link to="/about" className="text-white text-base font-medium hover:text-zinc-300 transition-colors">About</Link>
            <Link to="/contact" className="text-white text-base font-medium hover:text-zinc-300 transition-colors">Contact</Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="xl:hidden bg-[#0a0a0a] border-t border-zinc-800 px-4 py-4">
            <div className="flex flex-col gap-4">
              <button
                onClick={() => {
                  setIsCategoriesOverlayOpen(!isCategoriesOverlayOpen)
                  closeMobileMenu()
                }}
