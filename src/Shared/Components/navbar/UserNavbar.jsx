...
import Ozone_Logo from "../../../Assets/images/logo/Ozone_Logo.png"
...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-[#0a0a0a] border-b border-zinc-800">
      <div className="max-w-[1920px] mx-auto h-[60px] px-4 md:px-8 lg:px-80 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Mobile Menu Button */}
          <button
            className="lg:hidden text-white hover:text-zinc-300 transition-colors"
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="lg:hidden bg-[#0a0a0a] border-t border-zinc-800 px-4 py-4">
